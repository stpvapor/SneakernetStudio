#!/usr/bin/env bash
# update-studio.sh – FINAL, ZIG/CMAKE/RAYLIB STACK, NO LINKER ERRORS (2025-11-27)
...
log "============================================================="
log "     SneakernetStudio Updater – ZIG/CMAKE/RAYLIB"
...
# Toolchain_Zig.cmake – fixes linker depfile error with response files
...
# Fix for Zig linker --dependency-file error
set(CMAKE_C_USE_RESPONSE_FILE_FOR_INCLUDES 1)
set(CMAKE_C_USE_RESPONSE_FILE_FOR_OBJECTS 1)
set(CMAKE_C_USE_RESPONSE_FILE_FOR_LIBRARIES 1)
set(CMAKE_C_USE_RESPONSE_FILE_FOR_INPUTS 1)

set(CMAKE_CXX_USE_RESPONSE_FILE_FOR_INCLUDES 1)
set(CMAKE_CXX_USE_RESPONSE_FILE_FOR_OBJECTS 1)
set(CMAKE_CXX_USE_RESPONSE_FILE_FOR_LIBRARIES 1)
set(CMAKE_CXX_USE_RESPONSE_FILE_FOR_INPUTS 1)
