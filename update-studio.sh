#!/usr/bin/env bash
# update-studio.sh – FINAL, MUSL + NO CMAKE DEPFILES (2025-11-27)
...
log "============================================================="
log "     SneakernetStudio Updater – MUSL STATIC (WORKING)"
...
# Toolchain – musl + no CMake depfiles
...
# musl target = true static linking
