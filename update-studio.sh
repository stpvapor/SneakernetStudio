...
# Toolchain – strip --dependency-file from link command
...
# THIS IS THE ONLY LINE THAT ACTUALLY WORKS
set(CMAKE_C_COMPILER_LAUNCHER   "${CMAKE_COMMAND}" -E env "ZIG_NO_DEPFILE=1")
set(CMAKE_CXX_COMPILER_LAUNCHER "${CMAKE_COMMAND}" -E env "ZIG_NO_DEPFILE=1")
...
# Install correct CMakeLists.txt
