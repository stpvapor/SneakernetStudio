#!/usr/bin/env bash
# update-studio.sh – FIXED ZIG/CMAKE/RAYLIB STACK, EARLY TOOLCHAIN LOAD (2025-11-27)
...
# Toolchain_Zig.cmake – early load + link override
...
# Disable depfile support (fixes --dependency-file)
set(CMAKE_C_LINKER_DEPFILE_SUPPORTED FALSE)
set(CMAKE_CXX_LINKER_DEPFILE_SUPPORTED FALSE)

# Override link command to avoid depfile injection
set(CMAKE_C_LINK_EXECUTABLE "\${ZIG_EXE} cc <FLAGS> <LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")
...
# Install correct CMakeLists.txt in all templates (toolchain before project)
...
# Load toolchain BEFORE project() to set compiler early
